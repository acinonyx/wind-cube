...
$lang = array(
	...
	'all_routers' => "Δρομολογητες δικτύου",
	'active_routers' => "Ενεργοι Δρομολογητες",
	'routers_search' => "Αναζήτηση δρομολογητων",
	'routers_found' => "Δρομολογητες που βρέθηκαν",
	'routers_edit' => "Επεξεργασία δρομολογητη",
	'routers' => "Δρομολογητες",
	'routers_add' => "Προσθηκη Δρομολογητη",
	...
	'db' => array(
		...
		'links__live' => 'Live (RealTime) Κατάσταση',
		'links__live-active' => 'Ενεργό',
		'links__live-inactive' => 'Ανενεργό',
		'links__prepends' => 'Ανιχνευθηκαν BGP Prepends',
		'links__prepends_yes' => 'Ναι',
		...
		'nodes_routers__node_id' => 'Κόμβος',
		'nodes_routers__service_id' => 'Κατηγορία',
		'nodes_routers__date_in' => 'Προστέθηκε',
		'nodes_routers__ip_id' => 'Διεύθυνση IP',
		'nodes_routers__password' => 'BGP Read Only Κωδικος',
		'nodes_routers__status' => 'Κατάσταση',
		'nodes_routers__status-active' => 'Ενεργος',
		'nodes_routers__status-inactive' => 'Ανενεργος',
		'nodes_routers__port' => 'Πόρτα',
	...
	'help' => array(
		...
		'mynodes_routers_add' => array(
			'title' => 'Προσθήκη Δρομολογητη',
   			'body' => 'Στη σελίδα αυτή μπορείτε να προσθέσετε τον δρομολογητη του κομβου σας. Το πεδίο Διεύθυνση IP περιέχει όλες τις διευθύνσεις που έχετε δηλώσει και πρέπει να καθορίζει την IP στην οποία τρέχει (ακούει) ο δαιμονας του BGP στον δρομολογητη σας. Το πεδίο PORT, πρέπει να περιέχει την πορτα στην οποια ακουει ο BGP δαιμονας. Τελος το πεδιο Password αναφερεται στο Read Only Password του BGP δαιμονα.'
		),
		'mynodes_routers_edit' => array(
			'title' => 'Επεξεργασία Δρομολογητη',
			'body' => 'Στη σελίδα αυτή μπορείτε να επεξεργαστείτε τον δρομολογητη του κομβου σας. Το πεδίο Διεύθυνση IP περιέχει όλες τις διευθύνσεις που έχετε δηλώσει και πρέπει να καθορίζει την IP στην οποία τρέχει (ακούει) ο δαιμονας του BGP στον δρομολογητη σας. Το πεδίο PORT, πρέπει να περιέχει την πορτα στην οποια ακουει ο BGP δαιμονας. Τελος το πεδιο Password αναφερεται στο Read Only Password του BGP δαιμονα.'
		),
		'nodes_search' => array(
